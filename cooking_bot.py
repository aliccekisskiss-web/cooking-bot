    ...
    "Завтрак": {
        "Горячее": [
            ...
            },
            {
                ...
                "ingredients": ["Молоко - 500 мл", "Яйца - 3 шт.", "Мука - по вкусу", "Сахар, соль"],
                "recipe": "1. Смешайте все ингредиенты\n2. Дайте тесту постоять\n3. Жарьте по 2-3 минуты с каждой стороны"
            }
        ]
    },
    "Обед": {
        "Горячее": [
            ...
            },
            {
                ...
                "ingredients": ["Перец болгарский - 6 шт.", "Фарш - 400 г", "Рис - 150 г", "Лук - 2 шт.", "Морковь - 1 шт."],
                "recipe": "1. Обжарьте лук с морковью\n2. Смешайте с фаршем и рисом\n3. Начините перцы\n4. Тушите 40 минут"
            }
        ]
    },
    "Десерты": {
        "Выпечка": [
            ...
            },
            {
                ...
                "ingredients": ["Творожный сыр - 125 г", "Сахар - 120 г", "Яйца - 3 шт.", "Лимонный сок - 90 мл"],
                "recipe": "1. Смешайте все блендером\n2. Вылейте на основу\n3. Выпекайте 30 минут при 170°C"
            }
        ]
    }
}
